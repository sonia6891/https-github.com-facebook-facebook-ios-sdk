const CACHE_NAME='meow-work-pwa-v178';
const STATIC_ASSETS=['./index.html','./privacy.html','./terms.html','./support.html','./manifest.webmanifest?v=175','./assets/welcome-brand-v112.webp','./assets/mobile-hero-clean-v75.png','./assets/mobile-rest-card-v75.webp','./assets/meow-assistant-pro-v169.webp?v=169','./workcat-home-v12.png','./app-icon-v178-180.png?v=175','./app-icon-v178-192.png?v=175','./app-icon-v178-512.png?v=175','./splash-v178.jpg?v=175'];
