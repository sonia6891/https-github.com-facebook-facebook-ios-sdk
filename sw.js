const CACHE_NAME='meow-work-pwa-v122';
const STATIC_ASSETS=['./index.html','./manifest.webmanifest?v=122','./assets/welcome-brand-v112.webp','./assets/mobile-hero-clean-v75.png','./assets/mobile-rest-card-v75.webp','./workcat-home-v12.png','./app-icon-v115-180.png','./app-icon-v115-192.png','./app-icon-v115-512.png'];
