const CACHE_NAME='meow-work-pwa-v168';
const STATIC_ASSETS=['./index.html','./privacy.html','./terms.html','./support.html','./manifest.webmanifest?v=155','./assets/welcome-brand-v112.webp','./assets/mobile-hero-clean-v75.png','./assets/mobile-rest-card-v75.webp','./assets/meow-assistant-pro-v168.webp?v=168','./workcat-home-v12.png','./app-icon-v155-180.png?v=155','./app-icon-v155-192.png?v=155','./app-icon-v155-512.png?v=155'];
