const CACHE_NAME='meow-work-pwa-v154';
const STATIC_ASSETS=['./index.html','./privacy.html','./terms.html','./support.html','./manifest.webmanifest?v=154','./assets/welcome-brand-v112.webp','./assets/mobile-hero-clean-v75.png','./assets/mobile-rest-card-v75.webp','./workcat-home-v12.png','./app-icon-v154-180.png?v=154','./app-icon-v154-192.png?v=154','./app-icon-v154-512.png?v=154'];
