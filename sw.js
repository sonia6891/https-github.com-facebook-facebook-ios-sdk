const CACHE_NAME='meow-work-pwa-v153';
const STATIC_ASSETS=['./index.html','./privacy.html','./terms.html','./support.html','./manifest.webmanifest?v=153','./assets/welcome-brand-v112.webp','./assets/mobile-hero-clean-v75.png','./assets/mobile-rest-card-v75.webp','./workcat-home-v12.png','./app-icon-v153-180.png?v=153','./app-icon-v153-192.png?v=153','./app-icon-v153-512.png?v=153'];
