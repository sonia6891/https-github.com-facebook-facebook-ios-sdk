const CACHE_NAME='meow-work-pwa-v151';
const STATIC_ASSETS=['./index.html','./privacy.html','./terms.html','./support.html','./manifest.webmanifest?v=130','./assets/welcome-brand-v112.webp','./assets/mobile-hero-clean-v75.png','./assets/mobile-rest-card-v75.webp','./workcat-home-v12.png','./app-icon-v115-180.png','./app-icon-v115-192.png','./app-icon-v115-512.png'];
