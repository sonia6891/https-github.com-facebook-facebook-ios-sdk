...
with sync_playwright() as p:
 for engine,width in [('chromium',390),('webkit',390),('chromium',1440)]:
  ...
  try:
   ...
   for field in ['profile','schedule','dayStatus','personalEvents','months']:assert state[field]==seed[field],field+' altered'
