...
const STATIC_ASSETS=['./index.html','./manifest.webmanifest?v=112','./assets/welcome-brand-v112.webp','./assets/mobile-hero-clean-v75.png','./assets/mobile-rest-card-v75.webp','./workcat-home-v12.png'];
