...
Deno.serve(async (req: Request) => {
  ...
  form.append(
    "prompt",
    "台灣繁體中文。這是輪班工作 App 的簡短語音指令。請保留排班、班表、輪班、日期、時數、班別、加班、取消加班、請假、特休、發薪日、預估薪資、實領、應發、加班費、輪班津貼、夜班津貼、勞保、健保、福利金、勞退、所得稅、扣款、少發、多發、多扣、少扣、智慧薪資對帳、薪資對帳、薪資單、重新判讀、幫我對薪資單、核對薪資單等詞意。"
  );
  form.append(
    "file",
